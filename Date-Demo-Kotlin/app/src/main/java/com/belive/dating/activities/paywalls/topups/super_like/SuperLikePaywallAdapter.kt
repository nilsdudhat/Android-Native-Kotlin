...
import com.belive.dating.databinding.ItemSuperLikePaywallBinding
import com.belive.dating.extensions.logger
import com.revenuecat.purchases.Offering
import java.text.DecimalFormatSymbols
import java.util.Locale

class SuperLikePaywallAdapter(
    val viewModel: SuperLikePaywallViewModel,
    private val onOfferClickListener: OnOfferClickListener,
) :
    RecyclerView.Adapter<SuperLikePaywallAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemSuperLikePaywallBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val likeCount = (offering.metadata["super_like_count"] as String).toInt()
        ...
        holder.binding.pricePerSuperLike = StringBuilder().append(offerPrice[0]).append(pricePerLike).append(" / Super Like").toString()
    ...
    class ViewHolder(val binding: ItemSuperLikePaywallBinding) : RecyclerView.ViewHolder(binding.root)
}